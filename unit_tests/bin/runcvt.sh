...
"${TDI_JAVA_PROGRAM}" $TDI_MIXEDMODE_FLAG "-Dcom.ibm.di.installdir=${TDI_BIN_DIR}/.." "-Dcom.ibm.di.test.runner=com.ibm.di.test.runner.CVTFrameworkRunner" -jar "${UNIT_TESTS_HOME}/boot.jar" "$@"
