...
public class SessionUtils {
	...
	public static com.ibm.di.api.local.Session getServerApiSession(HttpServletRequest req) throws DIException, RemoteException, NotBoundException {
		return APIEngine.getLocalSession();
	}

	public static Session getRemoteServerApiSession(HttpServletRequest req) throws DIException, RemoteException, NotBoundException {
