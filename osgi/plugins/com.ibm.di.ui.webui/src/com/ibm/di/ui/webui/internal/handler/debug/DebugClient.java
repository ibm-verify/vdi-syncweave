...
public class DebugClient {
	 ...
	 * @param alc
	 */
	public DebugClient(String configId, String assemblyLine, MetamergeConfig mx) {
	 ...
	 * @throws Exception
	 */
	public void startAssemblyLine(BufferedWriter logWriter, int maxBufferLines) throws Exception {
...
//		if (isDebug()) {
			...
			//
			final StepperThread serverConnection = new StepperThread(this.configID + "_" + this.assemblylineName);
...
//		}
		...
		AssemblyLineListener logger = new AssemblyLineListener() {
...
//			logger.setLogWriter(logWriter);
		...
		// -- entry if requested
		//
		alListener = AssemblyLineListenerBase.createInstance(logger, api.isSSLon());
...
//		} else {
		assemblyLineHandle = configInstance.startAssemblyLine(this.assemblyline, tcb, alListener, true, false, true);
