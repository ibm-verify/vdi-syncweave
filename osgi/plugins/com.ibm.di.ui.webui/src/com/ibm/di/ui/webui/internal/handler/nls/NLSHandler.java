 ...
 */
package com.ibm.di.ui.webui.internal.handler.nls;
...
public class NLSHandler {
	...
	@Produces(MediaType.APPLICATION_JSON)
	/**
	 * This is the master NLS file that contains the root english fallback contents as well as
	 * a language code for each of the languages we support.
	 * 
	 * @param req
	 * @param file
	 * @return
	...
	public Response getDefaultMessageBundle(@Context HttpServletRequest req, @PathParam("file") String file) throws Exception {
		...
		// Add standard_forms.properties from tdiresource.jar
		addStandardForms(p, null);		
	...
	private void addStandardForms(Properties target, String lang) {
		String resource = "/NLS/standard_forms";
		if(lang != null)
			resource += "_" + lang;
		resource += ".properties";
