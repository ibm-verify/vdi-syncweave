 ...
 * @since 7.2
 */
public class LogQueueProducer extends QueueProducerBase implements LogListener {
	 ...
	 * @throws DIException
	 */
	public LogQueueProducer(PollChannel channel, ServletContext sctx) throws DIException {
		super(channel, sctx);
	}

	public void messageLogged(String msg) throws DIException, RemoteException {
		publishMessage(EventMapper.mapLogMessage(msg));
	}
}
