dojo.provide("tdi.TombstoneWidget");

dojo.require("tdi.tdiapi");
dojo.require("tdi.TreeTableWidget");

dojo.declare("tdi.TombstoneWidget",
	[tdi.TreeTableWidget],
	{
	// summary:
	...
	//		for a specific config/assemblyline
		...
		getTreeTableLayout : function() {
  			return [
				{field:"started", name:this.getString("started"), width:"auto", formatter:dojo.hitch(this, "flagErrors")},
				{field:"terminated", name:this.getString("stopped"), width:"auto"},
				{field:"exitCode", name:this.getString("exitStatus"), width:"auto"},
				{field:"userMessage", name:this.getString("userMessage"), width:"auto"},
				{field:"cycles", name:this.getString("cycles")}
			];
		},
