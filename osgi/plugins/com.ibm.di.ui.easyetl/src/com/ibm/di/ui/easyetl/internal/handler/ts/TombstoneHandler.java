 ...
 */
package com.ibm.di.ui.easyetl.internal.handler.ts;
...
import com.ibm.di.ui.easyetl.bind.Statistics;
import com.ibm.di.ui.easyetl.bind.Tombstones;
	...
	private Tombstones fromTombstones(Tombstone[] tslist) {
		...
		if(tslist != null) {
			for(Tombstone ts : tslist) {
				com.ibm.di.ui.easyetl.bind.Tombstone t = new com.ibm.di.ui.easyetl.bind.Tombstone();
