...
import com.ibm.tdi.eclipse.widget.SandboxWidget;

public class ALSandboxAction implements IObjectActionDelegate {
	...
	public ALSandboxAction() {
		super();
	}

	public ALSandboxAction(IWorkbenchPart part, AssemblyLineConfig target) {
		super();
		this.part = part;
		this.target = target;
	}
	...
	public void run(IAction action) {
		Dialog dlg = new Dialog(part.getSite().getShell()) {
			...
			protected Control createDialogArea(Composite parent) {
				...
				SandboxWidget widget = new SandboxWidget(c, SWT.TITLE, target);
