...
public class CompletionProposal implements ICompletionProposal {
	...
	public CompletionProposal(String replacementString, int replacementOffset, int replacementLength, int cursorPosition, Image image, String displayString, IContextInformation contextInformation, String additionalProposalInfo) {
		...
		fImage= image == null ? Activator.getImage("javafile_obj") : image;
	...
	public void setAdditionalProposalInfo(String info) {
		fAdditionalProposalInfo = info;
	}
	
	public void createAdditionalProposalInfo(Class<?> clazz, Method m) {
		try {
			StringBuffer buf = JavaDocReader.getJavaDocs(clazz, m);
			if(buf != null)
				fAdditionalProposalInfo = buf.toString();
		} catch (Exception e) {
