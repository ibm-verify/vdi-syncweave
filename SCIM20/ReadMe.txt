...
SCIM20.xml - This is the configuration file that implements the SCIM Service.

ServiceProviderConfig.json - This file is returned when the SCIM Service is asked for the ServiceProviderConfig

ResourceTypes.json - This file is returned when the SCIM Service is asked for the ResourceTypes
...
ibmdisrv -c SCIM20/SCIM20.xml -r SCIM_Service -w
