...
This package contains a single SyncWeave configuraion file, script_parser.xml. 
It contains both the implementation of the Parser and the AssemblyLines that demonstrate it.

To view the implementation of the Parser go to: SyncWeave Admin -> Parsers -> "BracketParser" -> "Script" tab.
...
SyncWeave Config Editor-> [Your project] -> AssemblyLines -> "XML To Bracket" AssemblyLine. 
...
SyncWeave Config Editor-> [Your project] -> AssemblyLines -> "Bracket To XML" AssemblyLine. 
