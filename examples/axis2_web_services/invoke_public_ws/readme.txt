...
This package contains a single IBM Security Verify Directory Integrator configuration file - axis2_isbn_example.xml, 
...
The configuration of the Axis2WSClientFunctionComponent-s can be seen by selecting IBM Security Verify Directory Integrator CE 
