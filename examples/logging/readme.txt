...
This is a simple IBM Security Verify Directory Integrator configuration that demonstrates the IBM Security Verify Directory Integrator logging functionality.
...
IBM Security Verify Directory Integrator Config Editor-> "Dump" AssemblyLine -> "Output" connector -> click the attribute named "singleValue".
You can find the JavaScript code that dumps a multiple values attribute in:
IBM Security Verify Directory Integrator Config Editor -> "Dump" AssemblyLine -> "Output" connector -> click the attribute named "multipleValues".
...
IBM Security Verify Directory Integrator Config Editor -> "Dump" AssemblyLine -> "Output" connector -> "Hooks" tab -> "AddOnly" sub-section -> click the "After Add" event.
