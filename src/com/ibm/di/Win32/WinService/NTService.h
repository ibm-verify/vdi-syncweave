...
#define SERVICE_NAMES 128

class CNTService
{
public:
    CNTService(const char *szServiceName, const char *szDisplayName);
    virtual ~CNTService();
...
public:
    ...
    // data members
    char m_szServiceName[SERVICE_NAMES];
	char m_szDisplayName[SERVICE_NAMES];
    ...
    // static data
    static CNTService* m_pThis; // a hack to get object ptr
