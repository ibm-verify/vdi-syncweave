 ...
 * PasswordStore decorated is the existing {@link JMSPasswordStore}.
 * </p>
 */
public class JMSPasswordStoreITIMDecorator implements PasswordStore, IPasswordSynchronizer {
	...
	private static final String PREFIX = JMSPasswordStore.PREFIX;
	...
	private static PasswordPolicyServiceBuilder getPolicyBuilder() throws ClassNotFoundException, PolicyInitializationException {
		...
		if (factClassProp == null || factClassProp.length() == 0) {
			System.setProperty(PasswordPolicyServiceBuilder.PROP_NAME_FACTORY_CLASS,
					JMSPasswordStoreITIMDecorator.DEFAULT_PASSWORD_POLICY_FACTORY_CLASS);
		}
	 ...
	 * defined in the configuration file named <b>mqepwstore.props</b>. This
	 ...
	 */
	public JMSPasswordStoreITIMDecorator() throws ClassNotFoundException, PolicyInitializationException, PolicyConnectionException,
			IllegalAccessException, InstantiationException {
		super();

		PasswordPolicyServiceBuilder builder = JMSPasswordStoreITIMDecorator.getPolicyBuilder();

		factory = builder.getFactory();
		PasswordPolicyService pps = factory.newPasswordPolicyService();
		PasswordStore sync = new JMSPasswordStore();
