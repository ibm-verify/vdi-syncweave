...
/**
 * The concrete implementation of the connectors' selectEntries() method. It's
 ...
 * 
 */
final class XslSelectMethod extends XslFindMethodBase {
	 ...
	 */
	public XslSelectMethod(Configuration cfg) {
		super(cfg);
	}
	...
	public File getPreCallXsl() {
		return (getConfig()
				.getParamAsFile(ConfigurationNames.PARAM_SELECT_ENTRIES_PRE_STYLESHEET));
	}
	...
	public File getPostCallXsl() {
		return (getConfig()
				.getParamAsFile(ConfigurationNames.PARAM_SELECT_ENTRIES_POST_STYLESHEET));
	}
