...
public final class AbapErrorInfo {
	...
	private static final int MISSING_USER_ERROR_NUM = 124;
	...
	/**
	 * Convenience method to determine if error indicates that the specified
	 * user does not exist.
	 * 
	 * @return <code>true</code> if {@link #getMsgNum} == 124.
	 */
	public boolean isMissingUserError() {
		return (getMsgNum().intValue() == AbapErrorInfo.MISSING_USER_ERROR_NUM);
	}
