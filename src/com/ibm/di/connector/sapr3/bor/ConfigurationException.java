...
/**
 * 
 * Exception type for SAP R/3 Connector. Thrown by connector to indicate user
 * configuration error to be corrected.
 */
public class ConfigurationException extends SapR3ConnectorException {
