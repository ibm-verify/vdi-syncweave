...
/**
 * Base exception type for SAP IDoc Connector. TDI assembly lines should expect
 * to handle this type.
 */
public class SapALEIDocConnectorException extends Exception {
	 ...
	 */
	public SapALEIDocConnectorException(String msg) {
		super(msg);
	}
	 ...
	 */
	public SapALEIDocConnectorException(Throwable root) {
		super(root);
	}
	 ...
	 *            The cause of the this exception.
	 */
	public SapALEIDocConnectorException(String msg, Throwable root) {
		super(msg, root);
	}
}
