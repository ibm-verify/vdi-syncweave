 ...
 * </p>
 * <code>
 var fc = system.getFunction("ibmdi.SapR3RfcFC");<br>
 ...
 reqType.addValue(SapR3RfcFC.PARAM_VAL_STRING);<br>
 entry.setAttribute(SapR3RfcFC.PARAM_INPUT_TYPE, reqType);<br>
 ...
 * </code>
 */
public final class SapR3RfcFC extends Function {
	 ...
	 */
	private static final String COMPONENT_NAME = "SAP ABAP AS RFC Functional Component";
	...
	*/
	...
	private RequestResponseType getRequestType(Object obj)
		...
		if (obj instanceof Entry) {
			...
			Attribute attrReqType = entry
					.getAttribute(SapR3RfcFC.PARAM_INPUT_TYPE);
			Attribute attrRequest = entry.getAttribute(SapR3RfcFC.PARAM_INPUT);
			if (attrReqType == null) {
				Object[] msgArgs = new Object[] { SapR3RfcFC.PARAM_INPUT_TYPE };
				String msg = LogMessageHelper.getMsgResource().getMessage(
						LogMessageHelper.SAPR3_RFCFC_0002, msgArgs);
				throw new SapR3FCParameterException(msg);
			}
			if (attrRequest == null) {
				Object[] msgArgs = new Object[] { SapR3RfcFC.PARAM_INPUT };
				String msg = LogMessageHelper.getMsgResource().getMessage(
						LogMessageHelper.SAPR3_RFCFC_0002, msgArgs);
				throw new SapR3FCParameterException(msg);
			}
	 ...
	 * <code>
	 ...
	 entry.setAttribute(SapR3RfcFC.PARAM_INPUT, inputAttrib);<br>
	 Attribute reqType = new Attribute();<br>
	 reqType.addValue(SapR3RfcFC.PARAM_VAL_MVA);<br>
	 entry.setAttribute(SapR3RfcFC.PARAM_INPUT_TYPE, reqType);<br>
	 </code>
	 * 
	 * 
	...
	public Object perform(Object obj) throws SapR3RfcFCException,
		...
		if (requestType.compareTo(RequestResponseType.DOMDOC) == 0) {
			...
			String xmlResult = getSapAdapter().sendReceive(getSapClient(),
					new StringReader(reqString), getLogProxy());
			response = new Entry();
	...
	private void initJcoConfigProperties() {
		...
		/*
		 * Get all know JCO parameters. Pitty there isn't some way to get a list
		 * of parameters ...
		 */
	 ...
	 */
	private void initJcoClientConnection() {
		// setSapClient(
