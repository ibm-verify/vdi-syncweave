...
set TDI_UPDATE_UTIL_CP=%TDI_HOME_DIR%\jars\3rdparty\IBM\icu4j-51_1.jar;%TDI_HOME_DIR%\jars\3rdparty\others\log4j-1.2-api-2.25.4.jar;%TDI_HOME_DIR%\jars\3rdparty\others\log4j-api-2.25.4.jar;%TDI_HOME_DIR%\jars\3rdparty\others\log4j-core-2.25.4.jar;%TDI_HOME_DIR%\jars\common\tdiresource.jar
set TDI_UPDATE_CP=%TDI_HOME_DIR%\maintenance\UpdateInstaller.jar;%TDI_UPDATE_UTIL_CP%

set LOG_4J=-Dlog4j.configuration="file:%TDI_HOME_DIR%\etc\updateinstaller-log4j.properties"
set UPDATE_JRE=0
set UPDATE_UI=0
...
set TDI_UPDATE_CP=%TDI_HOME_DIR%\maintenance\UpdateInstaller_tmp.jar;%TDI_UPDATE_UTIL_CP%
